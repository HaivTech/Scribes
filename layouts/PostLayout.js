...
export default function PostLayout({ post, frontMatter, authorDetails, next, prev, children }) {
  // const { slug, fileName, date, title, images, tags, readingTime } = frontMatter
  const { slug, createdAt, title, thumbnail, tags, meta, user } = post
